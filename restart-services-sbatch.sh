...
for job_name in B-ollama C-sync D-embed E-qdrant F-index Z-poll; do
...
echo "Submitting Z-poll (depends on B-ollama:$OLLAMA_JID, D-embed:$EMBED_JID, F-index:$INDEX_JID)..."
