...
#srun --account project_465003359 --partition=small-g --time=04:00:00 --ntasks=1 --cpus-per-task=1 --nodes=1 --mem=128GB singularity exec --bind "$PROJECT_ROOT:/workspace" "$SIF" python /workspace/2-inference/infer.py --model_dir /workspace/checkpoints/en/ --audio /workspace/2-inference/audio/sligo-triathlon-club-inviting-women-to-try-a-tri.mp3
